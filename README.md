...
| Component | Notes |
|---|---|
| [WeAct CAN485 V1.0 (ESP32)](https://github.com/WeActStudio/WeActStudio.CAN485DevBoardV1_ESP32/tree/master) | ESP32 + onboard CAN transceiver. The onboard 120Ω termination switch **must be OFF** when tapping mid-bus. |
| 3.3V–5V logic level shifter | Required between ESP32 (3.3V logic) and heater CAN bus (5V nominal) |
